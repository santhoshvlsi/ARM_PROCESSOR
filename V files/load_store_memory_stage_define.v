...
`define LOAD_STORE_MEMORY_STAGE_STORE_RD_DATA_START 109 //from reservation station

`define LOAD_STORE_MEMORY_STAGE_STORE_RD_DATA_END 78 //from reservation station
...
`define LOAD_STORE_MEMORY_STAGE_SWP_CTRL 13 //set zero for the time being
